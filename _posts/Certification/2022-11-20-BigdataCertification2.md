...
<span style='color:red'><u> 중심극한정리</u></span> : 불규칙한 형태의 모집단에서 표본 크기가 n인 표본을 여러 번 반복 추출하여 정규 분포의 형태를 이루는 그래프로 변환.  
> <span style='color:red'><u>표본 수가 작아도 모집단 통계량을 추정할 수 있다.</u></span>
